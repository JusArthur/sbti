  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-50 font-sans">
      <div className="max-w-[1080px] mx-auto px-4 py-8">
          ...
          <div className="max-w-[980px] mx-auto">
            ...
            <div className="mt-10 text-center">
              ...
              <button
                onClick={() => {
                  setScreen("result");
                  window.scrollTo({ top: 0, behavior: "smooth" }); // <-- Adds smooth scrolling to the top
                }}
                disabled={!isComplete}
        ...
        <div className="mt-20 flex justify-center items-center gap-8 pb-8">
          <a
            href="https://github.com/JusArthur/sbti"
            target="_blank"
            rel="noopener noreferrer"
            className="text-emerald-300 hover:text-emerald-700 transition-all transform hover:scale-110"
          ...
          <a
            href="https://tiktok.com/@justinxia30"
            target="_blank"
            rel="noopener noreferrer"
            className="text-emerald-300 hover:text-emerald-700 transition-all transform hover:scale-110"
          ...
          >
            {/* TikTok SVG Icon */}
            <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 15.68a6.34 6.34 0 006.35 6.32A6.33 6.33 0 0017.7 15.68V8.16a8.21 8.21 0 003.88 1v-3.49a4.84 4.84 0 01-1.99-.48z" />
            </svg>
          </a>
        </div>
      </div>
